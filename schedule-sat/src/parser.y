...
values:
      value_list {
          //printf("SchedSpec creating \n");
          $$ = new SchedSpec(
              static_cast<std::vector<std::vector<int>*>*>($1));
          //printf("SchedSpec created \n");
          Minisat::Solver solver;
          //printf("before rules \n");
          //static_cast<SchedSpec*>($$)->addDurationsRules(solver);
          //static_cast<SchedSpec*>($$)->addRules(solver);
          //static_cast<SchedSpec*>($$)->addRoomChangesRules(solver);
          static_cast<SchedSpec*>($$)->addGapRules(solver);
          static_cast<SchedSpec*>($$)->solveAndShowSolutions(solver);
